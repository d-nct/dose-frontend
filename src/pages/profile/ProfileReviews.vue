      ...
      <router-link v-for="review in reviewsStore.userReviews" :key="review._id"
        ...
        <div class="review-item q-mb-lg">
          ...
          <div class="row q-col-gutter-md">
            <div class="col-5 flex flex-column items-center"> <q-img
                :src="getImageUrl(review.imagem) || defaultImageUrl" :ratio="1" class="rounded-borders q-mb-sm">
            ...
            <div class="col-7">
              <div class="text-subtitle1">
                <span class="text-weight-bold">{{ review.usuario?.nome_usuario || "Eu" }}</span> disse:
              </div>
